...
const Folder = ({ handleInsertNode, explorer }) => {
    ...
    if (explorer.isFolder) {
        return (
            <div>
                <div>
                    <div className='cursor-default p-1 w-96 bg-gray-300 m-1 flex justify-between items-center' onClick={() => setExpand(!expand)}>
                        ...
                        <div>
                            ...
                            <button onClick={(e) => handleNewFolder(e, false)} className='cursor-pointer border-1  nm-1 text-sm p-1 bg-gray-100 w-24'>+ Add File</button>
                        </div>
